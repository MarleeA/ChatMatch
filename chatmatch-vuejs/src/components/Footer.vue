<template>
    <footer class="text-center text-white hidden md:block items-center space-x-1 bg-orange-200">
  <div class="container pt-9">
    <div class="flex justify-center mb-5">
      <a href="" target="_blank" class="mr-6 text-gray-800">
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="fab"
